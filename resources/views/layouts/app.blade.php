        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu Belum Dibikin</h6>
                        <a class="collapse-item" href="buttons.html">Menu Belum Dibikin</a>
                        <a class="collapse-item" href="cards.html">Menu Belum Dibikin</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="charts.html">
                    ...
                    <span>Menu Belum Dibikin</span></a>
            </li>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <a class="btn btn-success" href="https://abdulmanap.com">abdulmanap.com</a>
            </div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="/assets/sb-admin-2/img/undraw_profile.svg">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; {{ config('app.name', 'Laravel') }} |  <a href="https://abdulmanap.com">abdulmanap.com</a></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
